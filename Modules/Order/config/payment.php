    ...
    */
    'drivers' => [
        ...
        'idpay' => [
            ...
            '*' => false, // set it to true for test environments
            'currency' => 'R', //Can be R, T (Rial, Toman)
        ],
        'irankish' => [
        ...
        'zarinpal' => [
            ...
            'callbackUrl' => env('ZARINPAL_CALLBACK', config('app.url') . '/payments/verify/zarinpal'),
            'description' => 'پرداخت با درگاه زرین پال',
            'currency' => 'T', //Can be R, T (Rial, Toman)
        ],
        'zibal' => [
            /* normal api */
